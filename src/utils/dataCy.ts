export const dataCy = {
  ...
  ingredientsCategoryList: (title: string) => `ingredients-category-list-${title}`,
...
export const cySelectors = {
  ...
  burgerConstructorSelectedBunTop: cySel(dataCy.burgerConstructorSelectedBunTop),
  burgerConstructorSelectedBunBottom: cySel(dataCy.burgerConstructorSelectedBunBottom),
